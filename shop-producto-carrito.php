...
<body>
  <span class="name_page" style="display: none;" >Carrito</span>
  <!-- ========== HEADER ========== -->
        ...
        <div class="col-lg-8 mb-7 mb-lg-0">
          ...
          <form>
            ...
            <div class="border-bottom pb-5 mb-5">
              <div class="media">
                <div class="max-w-15rem w-100 mr-3">
                  <img class="img-fluid" src="assets/docs/producto/img_1.jpeg" alt="Image Description">
                </div>
                  ...
                  <div class="row">
                    <div class="col-md-7 mb-3 mb-md-0">
                      ...
                      <div class="d-block d-md-none">
                        <span class="h5 d-block mb-1">2,000.00</span>
                      </div>
            ...
            <div class="media mb-5 mb-md-10">
              <div class="max-w-15rem w-100 mr-3">
                <img class="img-fluid" src="assets/docs/producto/img_2.jpeg" alt="Image Description">
              </div>
              <div class="media-body">
                <div class="row">
                  <div class="col-md-7 mb-3 mb-md-0">
            ...
            <div class="media mb-5 mb-md-10">
              <div class="max-w-15rem w-100 mr-3">
                <img class="img-fluid" src="assets/docs/producto/img_3.jpeg" alt="Image Description">
              </div>
              <div class="media-body">
                <div class="row">
                  <div class="col-md-7 mb-3 mb-md-0">
            ...
            <div class="d-sm-flex justify-content-end">
              <a class="font-weight-bold" href="shop-classic.html">
          ...
          <div class="pl-lg-4">
            ...
            <div class="card shadow-soft p-4 mb-4">
              ...
              <div class="border-bottom pb-4 mb-4">
                <h2 class="h3 mb-0">Resumen del pedido</h2>
              </div>
              <!-- End Title -->
              ...
              <div class="border-bottom pb-4 mb-4">
                <div class="media align-items-center mb-3">
                  ...
                  <div class="media-body text-right">
                    <span class="text-dark font-weight-bold">S/. 6,000.00</span>
                  </div>
                </div>
                  ...
                  <div class="card-body p-0">
                    <div class="custom-control custom-radio d-flex align-items-center small">
                      ...
                      <label class="custom-control-label ml-1" for="deliveryRadio1">
                        <span class="d-block font-size-1 font-weight-bold mb-1">Gratis - Recojo en oficina</span>
                        <span class="d-block text-muted">Visitanos en nuestro local comercial.</span>
                      </label>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body p-0">
                    <div class="custom-control custom-radio d-flex align-items-center small">
                      ...
                      <label class="custom-control-label ml-1" for="deliveryRadio2">
                        <span class="d-block font-size-1 font-weight-bold mb-1">25.00 - Delivery urgente</span>
              ...
              <div class="media align-items-center mb-3">
                <span class="d-block font-size-1 mr-3">IGV</span>
                <div class="media-body text-right">
              ...
              <div class="row mx-1">                
                ...
                <div class="col px-1 my-1">
                  <a class="btn btn-primary btn-block btn-pill transition-3d-hover" target="_blank" href="https://api.whatsapp.com/send?phone=+51921305769&text=*Hola amigo*, ayudeme con este pedido!!"> <i class="fab fa-whatsapp"></i> Enviar</a>
                </div>
              </div>
            </div>
            <!-- End Order Summary -->
                ...
                <div class="card-header card-collapse" id="shopCartHeadingOne">
                  <h3 class="mb-0">
                    <a class="btn btn-link btn-block card-btn font-weight-bold collapsed" href="javascript:;" role="button"
                      ...
                      Código de Promoción?
                      <i class="far fa-question-circle text-body ml-1" data-container="body" data-toggle="popover" data-placement="top" data-trigger="hover" title="Código de Promoción" data-content="Válido solo en artículos de precio completo. Algunos productos pueden estar excluidos."></i>
                    </a>
                  </h3>
                </div>
                <div id="shopCartOne" class="collapse" aria-labelledby="shopCartHeadingOne" data-parent="#shopCartAccordion">
                  <form class="js-validate p-4">
                    <div class="input-group input-group-pill mb-3">
                      <input type="text" class="form-control" name="name" placeholder="Código de Promoción" aria-label="Código de Promoción">
