...
<!-- Mirrored from htmlstream.com/front/shop-categories.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 May 2021 14:21:23 GMT -->
<head>
  ...
  <!-- Title -->
  <title>Inicio | JDL Technology</title>
...
<body>
  <span class="name_page" style="display: none;" >Inicio</span>
  <!-- ========== HEADER ========== -->
  ...
  <main id="content" role="main">
    <!-- Alert Info -->
    <div class="alert alert-info text-center font-size-1 rounded-0 mb-0" role="alert">
      <span class="font-weight-bold">10% OFF</span> de descuento en pedidos superiores a S/ 2500.00: use el código JDL10OFF al finalizar la compra.
    </div>
    <!-- End Alert Info -->

    <!-- Hero Section -->
    <div class="bg-img-hero" style="background-image: url(assets/img/1920x800/img9.jpg);">
      <div class="container space-2 space-lg-3">
        <div class="w-md-65 w-lg-35">
          <div class="mb-4">
            <h1>
              La compras nunca fue mas
              <span class="text-primary text-highlight-warning">
                    <span class="js-text-animation"
                          data-hs-typed-options='{
                            "strings": ["fácil.", "rápido.", "seguro."],
                            "typeSpeed": 90,
                            "loop": true,
                            "backSpeed": 30,
                            "backDelay": 2500
            ...
            <p class="text-dark">Enviamos sus pedidos a nivel NACIONAL, realice sus compras sin nigun impedimento.</p>
          </div>
          <a class="btn btn-primary btn-pill transition-3d-hover px-5" href="shop-producto-grid.php">Comprar ahora</a>
        </div>
      </div>
    </div>
    <!-- End Hero Section -->
    ...
    <div class="container space-2 space-lg-3">
      ...
      <div class="w-md-80 w-lg-40 text-center mx-md-auto mb-5 mb-md-9">
        <h2>Nuestras mejores categorias</h2>
      </div>
      <!-- End Title -->
      ...
      <div class="row">
          ...
          <div class="card card-bordered shadow-none d-block">
            <div class="card-body d-flex align-items-center p-0">
              <div class="w-65 border-right">
                <img class="img-fluid" src="assets/docs/producto/img13.png" alt="Image Description">
              </div>
              <div class="w-35">
                <div class="border-bottom">
                  <img class="img-fluid" src="assets/docs/producto/img14.png" alt="Image Description">
                </div>
                <img class="img-fluid" src="assets/docs/producto/img15.png" alt="Image Description">
              </div>
            </div>
            <div class="card-footer text-center py-4">
              <h3 class="mb-1">Computo</h3>
              <span class="d-block text-muted font-size-1 mb-3">Desde S/. 159.00</span>
              <a class="btn btn-sm btn-outline-primary btn-pill transition-3d-hover px-5" href="#">Ver todo</a>
            </div>
          </div>
          <!-- End Card -->
        </div>
        ...
        <div class="col-md-4 mb-3">
          ...
          <div class="card card-bordered shadow-none d-block">
            ...
            <div class="card-footer text-center py-4">
              <h3 class="mb-1">Telefonia</h3>
              <span class="d-block text-muted font-size-1 mb-3">Desde S/. 299.00</span>
              <a class="btn btn-sm btn-outline-primary btn-pill transition-3d-hover px-5" href="#">Ver todo</a>
            </div>
          </div>
          <!-- End Card -->
        ...
        <div class="col-md-4 mb-3">
          ...
          <div class="card card-bordered shadow-none d-block">
            <div class="card-body d-flex align-items-center p-0">
              <div class="w-65 border-right">
                <img class="img-fluid" src="assets/docs/producto/img16.webp" alt="Image Description">
              </div>
              <div class="w-35">
                <div class="border-bottom">
                  <img class="img-fluid" src="assets/docs/producto/img17.png" alt="Image Description">
                </div>
                <img class="img-fluid" src="assets/docs/producto/img18.png" alt="Image Description">
              </div>
            </div>
            <div class="card-footer text-center py-4">
              <h3 class="mb-1">Casa inteligente</h3>
              <span class="d-block text-muted font-size-1 mb-3">Desde S/. 89.00</span>
              <a class="btn btn-sm btn-outline-primary btn-pill transition-3d-hover px-5" href="#">Ver todo</a>
            </div>
          </div>
          <!-- End Card -->
    ...
    <div class="container space-bottom-2 space-bottom-lg-3">
      ...
      <div class="row">
        <div class="col-sm-6 col-lg-3 mb-3 mb-sm-5">
          <!-- Card -->
          <div class="card card-bordered  d-block">
            <img class="card-img-top" src="assets/docs/producto/img12.png" alt="Image Description">
            <div class="card-footer text-center py-4">
              <h3 class="mb-1">S/. 245.34</h3>
              <span class="d-block text-muted font-size-1 mb-3">Camara de seguridad</span>
              <a class="btn btn-sm btn-outline-primary btn-pill transition-3d-hover px-5" href="#">Agregar al carrito</a>
            </div>
          </div>
          <!-- End Card -->
        </div>
        ...
        <div class="col-sm-6 col-lg-3 mb-3 mb-sm-5">
          <!-- Card -->
          <div class="card card-bordered  d-block">
            <img class="card-img-top" src="assets/docs/producto/img13.png" alt="Image Description">
            <div class="card-footer text-center py-4">
              <h3 class="mb-1">S/. 6450.00</h3>
              <span class="d-block text-muted font-size-1 mb-3">Laptop HP - 250 SDD - 16 RAM</span>
              <a class="btn btn-sm btn-outline-primary btn-pill transition-3d-hover px-5" href="#">Agregar al carrito</a>
            </div>
          </div>
          <!-- End Card -->
        ...
        <div class="col-sm-6 col-lg-3 mb-3 mb-sm-5">
          <!-- Card -->
          <div class="card card-bordered  d-block">
            <img class="card-img-top" src="assets/docs/producto/img14.png" alt="Image Description">
            <div class="card-footer text-center py-4">
              <h3 class="mb-1">S/. 756.00</h3>
              <span class="d-block text-muted font-size-1 mb-3">Impresora Canon</span>
              <a class="btn btn-sm btn-outline-primary btn-pill transition-3d-hover px-5" href="#">Agregar al carrito</a>
            </div>
          </div>
          <!-- End Card -->
        ...
        <div class="col-sm-6 col-lg-3 mb-3 mb-sm-5">
          ...
          <div class="card card-bordered  d-block">
            ...
            <div class="card-footer text-center py-4">
              <h3 class="mb-1">S/. 1567.00</h3>
              <span class="d-block text-muted font-size-1 mb-3">Laptop lenovo - 250 SDD - 16 RAM</span>
              <a class="btn btn-sm btn-outline-primary btn-pill transition-3d-hover px-5" href="#">Agregar al carrito</a>
            </div>
          </div>
          <!-- End Card -->
    ...
    <!-- Hero Section -->
    <div class="bg-img-hero-center" style="background-image: url(assets/img/1920x800/img8.jpg);">
      <div class="container space-2 space-lg-3">
        <div class="w-md-65 w-lg-35">
          <div class="mb-4">
            <h2 class="h1 text-white">Usa la mejor Tecnología</h2>
            <p class="text-white">La tecnologia es importante, pero lo unico que realmente importa es que hacemos cono ella.</p>
          </div>
          <a class="btn btn-light btn-pill transition-3d-hover px-5" href="#">Comprar productos</a>
        </div>
      </div>
    </div>
    <!-- End Hero Section -->
            ...
            <div class="col-lg-3 d-none d-lg-block">
              <div class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll bg-light" data-options='{direction: "reverse"}' style="overflow: visible;">
                <div data-parallaxanimation='[{property: "transform", value:" translate3d(0,{{val}}rem,0)", initial:"4", mid:"0", final:"-4"}]'>
                  <img class="img-fluid rounded-lg shadow-lg" src="assets/docs/persona/img_perfil/ing_laban.jpg" alt="Ing laban huaman">
              ...
              <div class="card-body h-100 rounded-lg p-0 p-md-4">
                ...
                <div class="row">
                  <div class="col-lg-8 mb-3 mb-lg-0">
                    <div class="pr-lg-5">
                      <blockquote class="h3 font-weight-normal mb-4">Vemos a <b>nuestros clientes</b> como los invitados de una fiesta en la que nosotros somos los anfitriones. Nuestro trabajo es hacer que cada aspecto importante de la <b>experiencia del consumidor</b>  sea un poco mejor.</blockquote>
                      <div class="media">
                        ...
                        <div class="media-body">
                          <span class="text-dark font-weight-bold">Ing. Baldwin Laban Huaman</span>
                          <span class="font-size-1">&mdash; CEO Cofunder</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-4 column-divider-lg">
                    ...
                    <div class="pl-lg-5">
                      ...
                      <p class="font-size-1">Los líderes usan Shop-JDL para estar actualizado en la mejor tecnologia de calidad.</p>
                      <a class="font-size-1 text-nowrap" href="#">Comprar productos <i class="fas fa-angle-right fa-sm ml-1"></i></a>
                    </div>
                  </div>
                </div>
              </div>
...
<!-- Mirrored from htmlstream.com/front/shop-categories.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 May 2021 14:21:25 GMT -->
</html>