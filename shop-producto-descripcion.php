...
<head>
  <!-- Title -->
  <title>Shop Single Product | Front - Responsive Website Template</title>
  ...
  <main id="content" role="main">
      ...
      <div class="row">
          ...
          <div class="pr-lg-4">
            <div class="position-relative">
              ...
              <div id="heroSlider" class="js-slick-carousel slick border rounded-lg"
                ...
                <div class="js-slide">
                  <img class="img-fluid w-100 rounded-lg" src="assets/docs/producto/img_1.jpeg" alt="Image Description">
                </div>
                <div class="js-slide">
                  <img class="img-fluid w-100 rounded-lg" src="assets/docs/producto/img_2.jpeg" alt="Image Description">
                </div>
                <div class="js-slide">
                  <img class="img-fluid w-100 rounded-lg" src="assets/docs/producto/img_3.jpeg" alt="Image Description">
                </div>
              </div>
              <!-- End Main Slider -->
                ...
                <div id="heroSliderNav" class="js-slick-carousel slick slick-gutters-1 slick-transform-off max-w-27rem mx-auto"
                  ...
                  <div class="js-slide p-1">
                    <a class="js-slick-thumb-progress d-block avatar avatar-circle border p-1" href="javascript:;">
                      <img class="avatar-img" src="assets/docs/producto/img_1.jpeg" alt="Image Description">
                    </a>
                  </div>
                  <div class="js-slide p-1">
                    <a class="js-slick-thumb-progress d-block avatar avatar-circle border p-1" href="javascript:;">
                      <img class="avatar-img" src="assets/docs/producto/img_2.jpeg" alt="Image Description">
                    </a>
                  </div>
                  <div class="js-slide p-1">
                    <a class="js-slick-thumb-progress d-block avatar avatar-circle border p-1" href="javascript:;">
                      <img class="avatar-img" src="assets/docs/producto/img_3.jpeg" alt="Image Description">
                    </a>
                  </div>
                </div>
              </div>
        ...
        <div class="col-lg-5">
          ...
          <div class="mb-4 text-center">
            <a href="#" type="button" class="btn btn-primary btn-pill transition-3d-hover">Agregar al carrito</a>
            <a href="shop-producto-carrito.php" type="button" class="btn btn-success btn-pill transition-3d-hover">Ir al carrito</a>
          </div>
    ...
    <div class="container space-top-2 space-lg-3">
      <div class="row">
        ...
        <div class="col-md-6 mb-5 mb-md-0">
          ...
          <div class="row">
            <div class="col-sm-6">
              <ul class="list-sm-article text-body mb-0">
    ...
    <div class="container">
      <div class="row justify-content-lg-between align-items-lg-center">
        ...
        <div class="col-lg-6">
          <div class="bg-img-hero-center h-100 min-h-450rem rounded-lg" style="background-image: url(assets/img/750x750/img3.jpg);"></div>
        </div>
      </div>
      ...
      <div class="row justify-content-lg-between align-items-lg-center space-top-1 space-top-lg-3">
        ...
        <div class="col-lg-6 order-lg-1">
          <div class="bg-img-hero-center h-100 min-h-450rem rounded-lg" style="background-image: url(assets/img/750x750/img4.jpg);"></div>
        </div>
      </div>
    </div>
            ...
            <div class="card-body pt-4 px-4 pb-0">
              <div class="mb-2">
                ...
                <span class="d-block font-size-1">
                  <a class="text-body" href="shop-single-product.html">Herschel backpack in dark blue</a>
                </span>
          ...
          <div class="card card-bordered shadow-none text-center w-100">
            ...
            <div class="card-body pt-4 px-4 pb-0">
              <div class="mb-2">
                ...
                <span class="d-block font-size-1">
                  <a class="text-body" href="shop-single-product.html">Front hoodie</a>
                </span>
                <div class="d-block">
          ...
          <div class="card card-bordered shadow-none text-center w-100">
            ...
            <div class="card-body pt-4 px-4 pb-0">
              <div class="mb-2">
                <a class="d-inline-block text-body small font-weight-bold mb-1" href="#">Accessories</a>
                <span class="d-block font-size-1">
                  <a class="text-body" href="shop-single-product.html">Herschel backpack in gray</a>
                </span>
                <div class="d-block font-size-1">
          ...
          <div class="card card-bordered shadow-none text-center w-100">
            ...
            <div class="card-body pt-4 px-4 pb-0">
              <div class="mb-2">
                <a class="d-inline-block text-body small font-weight-bold mb-1" href="#">Clothing</a>
                <span class="d-block font-size-1">
                  <a class="text-body" href="shop-single-product.html">Front Originals adicolor t-shirt with trefoil logo</a>
                </span>
                <div class="d-block">
          ...
          <div class="card card-bordered shadow-none text-center w-100">
            ...
            <div class="card-body pt-4 px-4 pb-0">
              <div class="mb-2">
                <a class="d-inline-block text-body small font-weight-bold mb-1" href="#">Accessories</a>
                <span class="d-block font-size-1">
                  <a class="text-body" href="shop-single-product.html">Front mesh baseball cap with signature logo</a>
                </span>
                <div class="d-block">
          ...
          <div class="card card-bordered shadow-none text-center w-100">
            ...
            <div class="card-body pt-4 px-4 pb-0">
              <div class="mb-2">
                <a class="d-inline-block text-body small font-weight-bold mb-1" href="#">Clothing</a>
                <span class="d-block font-size-1">
                  <a class="text-body" href="shop-single-product.html">Front Originals adicolor t-shirt in gray</a>
                </span>
                <div class="d-block">
          ...
          <div class="card card-bordered shadow-none text-center w-100">
            ...
            <div class="card-body pt-4 px-4 pb-0">
              <div class="mb-2">
                <a class="d-inline-block text-body small font-weight-bold mb-1" href="#">Clothing</a>
                <span class="d-block font-size-1">
                  <a class="text-body" href="shop-single-product.html">COLLUSION Unisex mechanic print t-shirt</a>
                </span>
                <div class="d-block">
          ...
          <div class="card card-bordered shadow-none text-center w-100">
            ...
            <div class="card-body pt-4 px-4 pb-0">
              <div class="mb-2">
                <a class="d-inline-block text-body small font-weight-bold mb-1" href="#">Accessories</a>
                <span class="d-block font-size-1">
                  <a class="text-body" href="shop-single-product.html">Billabong Walled snapback in green</a>
                </span>
                <div class="d-block">
    ...
    <!-- Subscribe Section -->
    <div class="bg-dark">
      <div class="container border-bottom space-2">
        <div class="row justify-content-center">
          <div class="col-md-9 col-lg-6">
            <!-- Title -->
            <div class="text-center mb-4">
              <h2 class="h1 text-white">Stay in the know</h2>
...
<!-- Mirrored from htmlstream.com/front/shop-single-product.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 May 2021 14:21:32 GMT -->
</html>