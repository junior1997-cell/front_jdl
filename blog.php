...
<!-- Mirrored from htmlstream.com/front/blog-journal.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 May 2021 14:20:45 GMT -->
<head>
  ...
  <!-- Title -->
  <title>Blog Journal | JDL Technology</title>
...
<body>
  <span class="name_page" style="display: none;" >Blog</span>
  <!-- ========== HEADER ========== -->
  ...
  <main id="content" role="main">
    ...
    <div class="position-relative">
      ...
      <div id="heroSlider" class="js-slick-carousel slick"
        ...
        <div class="js-slide d-flex gradient-x-overlay-sm-dark bg-img-hero min-h-620rem" style="background-image: url(assets/img/1920x1080/img3.jpg);">
          <!-- News Block -->
            ...
            <div class="w-lg-40 mr-5">
              ...
              <div class="media align-items-center mb-3"
                ...
                <div class="media-body">
                  <a class="text-white" href="blog-single-article.html">Christina Kray</a>
                </div>
              </div>
              <!-- End Author -->
              ...
              <a class="btn btn-primary btn-wide transition-3d-hover" href="blog-single-article.html"
                 data-hs-slick-carousel-animation="fadeInUp"
        ...
        <div class="js-slide d-flex gradient-x-overlay-sm-dark bg-img-hero min-h-620rem" style="background-image: url(assets/img/1920x1080/img5.jpg);">
          <!-- News Block -->
          <div class="container d-flex align-items-center min-h-620rem">
            <div class="w-lg-40 mr-5">
              <!-- Author -->
        ...
        <div class="js-slide d-flex gradient-x-overlay-sm-dark bg-img-hero min-h-620rem" style="background-image: url(assets/img/1920x1080/img4.jpg);">
          <!-- News Block -->
          <div class="container d-flex align-items-center min-h-620rem">
            <div class="w-lg-40 mr-5">
              <div class="mb-7">
                ...
                <div class="media align-items-center mb-3"
                  ...
                  <div class="media-body">
                    <a class="text-white" href="blog-single-article.html">Jeff Fisher</a>
                  </div>
                </div>
                <!-- End Author -->
    ...
    <div class="container space-2 space-lg-3">
      <div class="row justify-content-lg-between">
        <div class="col-lg-8">
          ...
          <article class="row mb-7">
            ...
            <div class="col-md-7">
              <div class="card-body d-flex flex-column h-100 px-0">
                ...
                <h3><a class="text-inherit" href="blog-single-article.html">Enjoy $1,000 worth of perks with Front for Business</a></h3>
          ...
          <article class="row mb-7">
            ...
            <div class="col-md-7">
              <div class="card-body d-flex flex-column h-100 px-0">
                ...
                <h3><a class="text-inherit" href="blog-single-article.html">What CFR (Conversations, Feedback, Recognition) really is about</a></h3>
          ...
          <!-- Blog -->
          <article>
            <a class="card align-items-start flex-wrap flex-row h-380rem gradient-x-overlay-sm-dark bg-img-hero rounded-lg-pseudo transition-3d-hover mb-7" href="blog-profile.html" style="background-image: url(assets/img/900x450/img1.jpg);">
          ...
          <article class="row mb-7">
            ...
            <div class="col-md-7">
              <div class="card-body d-flex flex-column h-100 px-0">
                ...
                <h3><a class="text-inherit" href="blog-single-article.html">Let's revolutionise global payments. Together</a></h3>
...
<!-- Mirrored from htmlstream.com/front/blog-journal.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 May 2021 14:20:57 GMT -->
</html>