...
Class Tipo
{
	...
	public function insertar($nombre_tipo, $descripcion)
	{
		...
		$sql_bit = "INSERT INTO bitacora_bd( idcodigo, nombre_tabla, id_tabla, sql_d, id_user) VALUES ('tipo_persona','".$intertar['data']."','Nuevo tipo trabajador registrado','$this->id_usr_sesion')";
	...
	public function editar($idtipo_persona,$nombre_tipo,$descripcion)
	{
		...
		//add registro en nuestra bitacora
		$sql_bit = "INSERT INTO bitacora_bd( idcodigo, nombre_tabla, id_tabla, sql_d, id_user) VALUES ('tipo_persona','$idtipo_persona','Tipo trabajador editado','$this->id_usr_sesion')";
		$bitacora = ejecutarConsulta($sql_bit); if ( $bitacora['status'] == false) {return $bitacora; }  
	...
	public function desactivar($idtipo_persona)
	{
		...
		//add registro en nuestra bitacora
		$sql_bit = "INSERT INTO bitacora_bd( idcodigo, nombre_tabla, id_tabla, sql_d, id_user) VALUES ('tipo_persona','".$idtipo_persona."','Tipo trabajador desactivado','$this->id_usr_sesion')";
		$bitacora = ejecutarConsulta($sql_bit); if ( $bitacora['status'] == false) {return $bitacora; }   
	...
	public function eliminar($idtipo_persona)
	{
		...
		//add registro en nuestra bitacora
		$sql = "INSERT INTO bitacora_bd( idcodigo, nombre_tabla, id_tabla, sql_d, id_user) VALUES ('tipo_persona','$idtipo_persona','Tipo trabajador Eliminado','$this->id_usr_sesion')";
