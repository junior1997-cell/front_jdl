...
class Compra_producto
{
  ...
  $precio_con_igv,$precio_venta, $descuento, $tipo_gravada) {    
    ...
    if (empty($compra_existe['data']) || $tipo_comprobante == 'Ninguno') {
      ...
      $sql_bit = "INSERT INTO bitacora_bd( idcodigo, nombre_tabla, id_tabla, sql_d, id_user) VALUES ('compra_producto','".$idventanew['data']."','Nueva compra','$this->id_usr_sesion')";
      ...
      if ( !empty($idventanew['data']) ) {
        ...
        while ($num_elementos < count($idproducto)) {
          ...
          //add registro en nuestra bitacora.
          $sql_bit_d = "INSERT INTO bitacora_bd( idcodigo, nombre_tabla, id_tabla, sql_d, id_user) VALUES ('detalle_compra_producto','".$compra_new['data']."','Detalle compra','$this->id_usr_sesion')";
