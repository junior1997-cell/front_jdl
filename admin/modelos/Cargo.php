...
Class Cargo
{
	...
	public function insertar($nombre)
	{
		...
		$sql_bit = "INSERT INTO bitacora_bd( idcodigo, nombre_tabla, id_tabla, sql_d, id_user) VALUES ('cargo_trabajador','".$intertar['data']."','Nuevo cargo trabajador registrado','$this->id_usr_sesion')";
	...
	public function editar($idcargo_trabajador,$nombre)
	{
		...
		//add registro en nuestra bitacora
		$sql_bit = "INSERT INTO bitacora_bd( idcodigo, nombre_tabla, id_tabla, sql_d, id_user) VALUES ('cargo_trabajador','$idcargo_trabajador','Cargo trabajador editado','$this->id_usr_sesion')";
		$bitacora = ejecutarConsulta($sql_bit); if ( $bitacora['status'] == false) {return $bitacora; }  
	...
	public function desactivar($idcargo_trabajador)
	{
		...
		//add registro en nuestra bitacora
		$sql_bit = "INSERT INTO bitacora_bd( idcodigo, nombre_tabla, id_tabla, sql_d, id_user) VALUES ('cargo_trabajador','".$idcargo_trabajador."','Cargo trabajador desactivado','$this->id_usr_sesion')";
		$bitacora = ejecutarConsulta($sql_bit); if ( $bitacora['status'] == false) {return $bitacora; }   
	...
	public function eliminar($idcargo_trabajador)
	{
		...
		//add registro en nuestra bitacora
		$sql = "INSERT INTO bitacora_bd( idcodigo, nombre_tabla, id_tabla, sql_d, id_user) VALUES ('cargo_trabajador','$idcargo_trabajador','Cargo trabajador Eliminado','$this->id_usr_sesion')";
