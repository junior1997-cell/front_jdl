...
Class Color
{
	...
	public function insertar($nombre, $hexadecimal) {
		...
		$sql_d = "$nombre, $hexadecimal";
		$sql_bit = "INSERT INTO bitacora_bd( idcodigo, nombre_tabla, id_tabla, sql_d, id_user) VALUES (5, 'color', '$id', '$sql_d', '$this->id_usr_sesion')";
	...
	public function editar($idcolor, $nombre, $hexadecimal) {
		...
		//add registro en nuestra bitacora
		$sql_d = "$idcolor, $nombre, $hexadecimal";
		$sql_bit = "INSERT INTO bitacora_bd( idcodigo, nombre_tabla, id_tabla, sql_d, id_user) VALUES (6, 'color','$idcolor','$sql_d','$this->id_usr_sesion')";
		$bitacora = ejecutarConsulta($sql_bit); if ( $bitacora['status'] == false) {return $bitacora; }  
	...
	public function desactivar($idcolor) {
		...
		//add registro en nuestra bitacora
		$sql_bit = "INSERT INTO bitacora_bd( idcodigo, nombre_tabla, id_tabla, sql_d, id_user) VALUES (2, 'color','$idcolor','$idcolor','$this->id_usr_sesion')";
		$bitacora = ejecutarConsulta($sql_bit); if ( $bitacora['status'] == false) {return $bitacora; }   
	...
	public function eliminar($idcolor) {
		...
		//add registro en nuestra bitacora
		$sql = "INSERT INTO bitacora_bd( idcodigo, nombre_tabla, id_tabla, sql_d, id_user) VALUES (4, 'color','$idcolor','$idcolor','$this->id_usr_sesion')";
