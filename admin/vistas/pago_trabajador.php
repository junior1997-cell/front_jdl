              ...
              <section class="content">
                      ...
                      <div class="card card-primary card-outline">
                        <div class="card-header">
                          ...
                          <h3 class="card-title mr-3"  style="padding-left: 2px;"  >
                            <button type="button" class="btn bg-gradient-primary" id="btn-regresar-todo" data-toggle="modal" data-target="#modal-agregar-pago-all-trabajador" onclick="mostrar_all_trabajadores();" ><i class="fa-solid fa-circle-plus"></i> Agregar Pagos</button>
                          </h3>
                          <!-- agregar mes -->
                          <h3 class="card-title">                            
                ...
                <div class="modal fade" id="modal-agregar-pago-all-trabajador">
                  <div class="modal-dialog modal-dialog-scrollable modal-lg">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h4 class="modal-title">Agregando pagos</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span class="text-danger" aria-hidden="true">&times;</span>
                        </button>
                      </div>
