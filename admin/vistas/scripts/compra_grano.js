...
var host = window.location.host == 'localhost'? `http://localhost//dist/docs/compra_insumo/comprobante_compra/` : `${window.location.origin}/dist/docs/compra_insumo/comprobante_compra/` ;
