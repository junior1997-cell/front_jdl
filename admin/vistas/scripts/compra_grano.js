...
var host = window.location.host == 'localhost'? `http://localhost//dist/docs/compra_insumo/comprobante_compra/` : `${window.location.origin}/admin/dist/docs/compra_insumo/comprobante_compra/` ;
