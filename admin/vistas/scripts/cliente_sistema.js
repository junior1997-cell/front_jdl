...
function init() {
  ...
  lista_select2("../ajax/ajax_general.php?op=select2Persona_por_tipo&tipo=4", '#cliente', null);
  ...
  // ══════════════════════════════════════ INITIALIZE SELECT2 ══════════════════════════════════════  
  $("#cliente").select2({theme:"bootstrap4", placeholder: "Selecione", allowClear: true, });
      ...
      e.data.forEach((val, key) => {
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3 d_trabajador_${val.idpersona}">
          <div class="form-group">
            ...
            <select name="mes_all[${val.idpersona}]" id="mes_all_${val.idpersona}" class="form-control select2 select_mes" placeholder="Mes" onchange="replicar_value_input(${val.idpersona}, this, '#mes_all_h_${val.idpersona}')">
            ...
            <select name="anio_all[${val.idpersona}]" id="anio_all_${val.idpersona}" class="form-control select2 select_anio pt-1" placeholder="Seleccione" onchange="replicar_value_input(${val.idpersona}, this, '#anio_all_h_${val.idpersona}')">                                    
            </select>
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-2 col-xl-2 d_trabajador_${val.idpersona}">
          <div class="form-group">
            ...
            <input type="text" name="monto_all[${val.idpersona}]" id="monto_all_${val.idpersona}" class="form-control" placeholder="Monto" onkeyup="replicar_value_input(${val.idpersona}, this, '#monto_all_h_${val.idpersona}')" />
...
function ver_img_persona(file, url_carpeta, nombre) {
  ...
  $('#perfil-persona').html(doc_view_extencion(file, url_carpeta, '100%'));
