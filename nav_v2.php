<nav class="js-mega-menu navbar navbar-expand-lg">
  ...
  <a class="navbar-brand" href="index.php" aria-label="Front">
    <img src="assets/svg/logos/logo_v2.svg" alt="Logo">
  </a>
  <!-- End Logo -->
    ...
    <div class="navbar-body header-abs-top-inner">
      <ul class="navbar-nav">
        ...
        <li class="navbar-nav-item">
          <a id="pagesMegaMenu" class="hs-mega-menu-invoker nav-link /*nav-link-toggle*/" href="javascript:;" aria-haspopup="true" aria-expanded="false" aria-labelledby="pagesSubMenu">Inicio</a>          
        </li>
        <!-- End Home -->   
        ...
        <li class="hs-has-mega-menu navbar-nav-item">
          ...
          <!-- Home - Mega Menu -->
          <div class="hs-mega-menu dropdown-menu w-100 shadow-lg" aria-labelledby="homeMegaMenu">
        ...
        <li class="hs-has-mega-menu navbar-nav-item"
          ...
          <a id="shopMegaMenu" class="hs-mega-menu-invoker nav-link nav-link-toggle " href="javascript:;" aria-haspopup="true" aria-expanded="false">Compras</a>

          <!-- Shop - Mega Menu -->
          <div class="hs-mega-menu dropdown-menu hs-position-right" aria-labelledby="shopMegaMenu">
            <div class="mega-menu-body">
              <span class="d-block h5">Elementos de la tienda</span>
        ...
        <!-- Blog -->
        <li class="navbar-nav-item">
          <a id="blogMegaMenu" class="hs-mega-menu-invoker nav-link /*nav-link-toggle*/ active" href="blog.php" aria-haspopup="true" aria-expanded="false" aria-labelledby="blogSubMenu">Blog</a>
        </li>
        <!-- End Blog -->                 
