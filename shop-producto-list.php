...
<!-- Mirrored from htmlstream.com/front/shop-products-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 May 2021 14:21:25 GMT -->
<head>
...
<body>
  <span class="name_page" style="display: none;" >Tienda de Productos list</span>
  <!-- ========== HEADER ========== -->
      ...
      <div class="row">
        <div class="col-lg-9">
              ...
              <div class="d-flex justify-content-sm-end align-items-center">
                ...
                <ul class="nav nav-segment">
                  <li class="list-inline-item">
                    <a class="nav-link" href="shop-producto-grid.php">
                      <i class="fas fa-th-large"></i>
                    </a>
                  </li>
                  <li class="list-inline-item">
                    <a class="nav-link active" href="shop-producto-list.php">
          ...
          <ul class="list-unstyled">
            ...
            <li class="card card-bordered shadow-none mb-3 mb-md-5">
              <div class="row no-gutters">
                <div class="col-md-4">
                  <img class="card-img" src="assets/img/320x320/img12.jpg" alt="Image Description">
                </div>
            ...
            <li class="card card-bordered shadow-none mb-3 mb-md-5">
              <div class="row no-gutters">
                <div class="col-md-4">
                  <img class="card-img" src="assets/img/320x320/img13.jpg" alt="Image Description">
                </div>
            ...
            <li class="card card-bordered shadow-none mb-3 mb-md-5">
              <div class="row no-gutters">
                <div class="col-md-4">
                  <img class="card-img" src="assets/img/320x320/img7.jpg" alt="Image Description">
                </div>
            ...
            <li class="card card-bordered shadow-none mb-3 mb-md-5">
              <div class="row no-gutters">
                <div class="col-md-4">
                  <img class="card-img" src="assets/img/320x320/img11.jpg" alt="Image Description">
                </div>
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    <div class="mb-2">
                      ...
                      <ul class="list-sm-article text-body font-size-1 pl-4 mb-2">
                        <li>Imported</li>
                        <li>Product color: Dark-Green</li>
                        <li>Product code: CH7652</li>
                      </ul>
                      <div class="d-block">
            ...
            <ul class="pagination justify-content-between align-items-center">
              ...
              <li class="page-item">
                <div class="d-flex align-items-center">
                  ...
                  <span class="d-none d-sm-inline-block text-body">of 6</span>
                </div>
              </li>
              <li class="page-item">
        ...
        <div class="col-lg-3">
          <form>
            ...
            <button type="button" class="btn btn-sm btn-block btn-soft-secondary transition-3d-hover">Borrar todo</button>
          </form>
        </div>
        <!-- End Filters -->
      </div>
...
<!-- Mirrored from htmlstream.com/front/shop-products-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 May 2021 14:21:28 GMT -->
</html>